                            ...
                            <table class="table table-striped"> 
                                ...
                                <tbody> 
                                    ...
                                    <tr> 
                                        ...
                                        <td><?php echo $row[$model]['role']; ?></td> 
                                        <td>
										<?php if ($row[$model]['status']==1) echo '<span class="label label-success">' .$this->Psd->text('Active') .'</span>'; ?>
                                        <?php if ($row[$model]['status']==0) echo '<span class="label label-default">' .$this->Psd->text('Inactive') .'</span>'; ?>
                                        </td>
                                        <td>
                                            <?php 
                                              echo $this->Html->link(
