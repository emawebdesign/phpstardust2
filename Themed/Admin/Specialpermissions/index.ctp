<div class="panel panel-default">
  <div class="panel-body">
  	...
  	<h1><?php echo $this->Psd->text('Permissions'); ?> <span class="badge"><?php echo $count; ?></span></h1>
                    	...
                    	<div class="table-responsive">
                            <table class="table table-striped"> 
                                <thead> 
                                    <tr> 
                                        <th>#</th> 
                                        <th><?php echo $this->Psd->text('Role'); ?></th> 
                                        <th>Plugin</th> 
                                        <th>Controller</th> 
                                        <th>Action</th>
                                        <th><?php echo $this->Psd->text('Permission'); ?></th> 
                                ...
                                <tbody> 
                                    ...
                                    <tr> 
                                        ...
                                        <td><?php echo $row['Customrole']['name']; ?></td> 
                                        <td>
											<?php 
                                            if ($row[$model]['plugin']!="") echo $row[$model]['plugin']; 
											else echo "-";
                                            ?>
                                        </td>
                                        <td><?php echo $row[$model]['controller']; ?></td>
                                        <td><?php echo $row[$model]['action']; ?></td>
                                        <td>
                                        	<?php if ($row[$model]['permission']=="allow") echo '<span class="label label-success">Allow</span>'; ?>
                                            <?php if ($row[$model]['permission']=="deny") echo '<span class="label label-warning">Deny</span>'; ?>
                                        </td>
                                        <td>
                                            <?php 
                                              echo $this->Html->link(
