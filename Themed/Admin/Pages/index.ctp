                            ...
                            <table class="table table-striped"> 
                                ...
                                <tbody> 
                                    ...
                                    <tr> 
                                        ...
                                        <td>
                                        	<?php if ($row[$model]['status']=="public") echo '<span class="label label-success">' .$this->Psd->text('Public') .'</span>'; ?>
                                            <?php if ($row[$model]['status']=="private") echo '<span class="label label-default">' .$this->Psd->text('Private') .'</span>'; ?>
                                        </td>
                                        <td>
                                            <?php 
                                              echo $this->Html->link(
