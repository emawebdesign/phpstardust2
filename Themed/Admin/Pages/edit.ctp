<div class="panel panel-default">
  <div class="panel-body">
  	...
  	<h1><?php echo $this->Psd->text(Inflector::pluralize($model)); ?> / <?php echo $this->Psd->text('Edit'); ?></h1>
    
    <div class="row">
    
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        
        	<p><a href="<?php echo Configure::read('Psd.url'); ?>/<?php echo $this->data[$model]["slug"]; ?>" target="_blank"><i class="fa fa-eye"></i> <?php echo $this->Psd->text('View'); ?></a></p>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class='input-group date' id='created'>
                                <input type='text' class="form-control" name="data[<?php echo $model; ?>][created]" value="<?php echo $this->data["Page"]["created"]; ?>" />
                          ...
                          <div class="form-group">
                            ...
                            echo $this->Form->input('status',array(
                                'options' => array(
									'private' => $this->Psd->text('Private'), 
									'public' => $this->Psd->text('Public')
								),
    ...
    <div class="row">
    	...
    	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        	...
        	<?php echo $this->element('dropzone', array('model' => $model, 'field' => 'image')); ?>
