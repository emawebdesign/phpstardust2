<div class="panel panel-default">
  <div class="panel-body">
  	...
  	<h1><?php echo $this->Psd->text(Inflector::pluralize($model)); ?> / <?php echo $this->Psd->text('Website\'s data'); ?></h1>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            echo $this->Form->input('description',array(
                                ...
                                'class' => 'form-control input-lg',
								'label' => 'Meta ' .$this->Psd->text('Description'),
								'error' => array('attributes' => array('wrap' => 'div','class' => 'alert alert-warning help-block'))
                            ));
                          ...
                          <div class="form-group">
                             <div class="checkbox checkbox-success">
                                <?php
                                echo $this->Form->checkbox('enableog', array(
                                    'value' => 1,
                                    'hiddenField' => 'N',
                                    'id' => 'enableog',
                                    'class' => 'styled',
                          ...
                          <div class="form-group">
                            ...
                            echo $this->Form->input('ogtype',array(
                                'id' => 'ogtype',
                                'placeholder' => $this->Psd->text('Enter') .' OG Type',
                                'class' => 'form-control input-lg',
								'label' => 'OG Type',
								'error' => array('attributes' => array('wrap' => 'div','class' => 'alert alert-warning help-block'))
                            ));
                          ...
                          <div class="form-group">
                            ...
                            echo $this->Form->input('ogimage', array(
                                'label' => 'OG Image',
                                'type' => 'file',
                                'error' => array('attributes' => array('wrap' => 'div','class' => 'alert alert-warning help-block'))
                            ));
							
							if ($this->data["Setting"]["ogimage"]!="") echo '<p style="margin-top:10px"><a class="btn btn-adf btn-sm" href="' .Configure::read('Psd.url') .'/files/uploads/' .$this->data["Setting"]["ogimage"] .'" target="_blank">' .$this->Psd->text('View file') .'</a></p>';
                          ...
                          <div class="form-group">
                            ...
                            echo $this->Form->input('language',array(
                                'options' => array(
									"en" => $this->Psd->text('English'),
									"it" => $this->Psd->text('Italian')
								),				
								'placeholder' => $this->Psd->text('Enter') .' language',
                                'class' => 'form-control input-lg',
								'label' => $this->Psd->text('Language'),
								'error' => array('attributes' => array('wrap' => 'div','class' => 'alert alert-warning help-block'))
                            ));
                          ...
                          <div class="form-group">
                            ...
                            echo $this->Form->input('facebook_profile',array(
                                'id' => 'facebook_profile',
                                'placeholder' => $this->Psd->text('Enter') .' Facebook URL',
                                'class' => 'form-control input-lg',
								'label' => 'Facebook URL',
								'error' => array('attributes' => array('wrap' => 'div','class' => 'alert alert-warning help-block'))
                            ));
                          ...
                          <div class="form-group">
                            ...
                            echo $this->Form->input('googleplus_profile',array(
                                'id' => 'googleplus_profile',
                                'placeholder' => $this->Psd->text('Enter') .' Google+ URL',
                                'class' => 'form-control input-lg',
								'label' => 'Google+ URL',
								'error' => array('attributes' => array('wrap' => 'div','class' => 'alert alert-warning help-block'))
                            ));
                          ...
                          <div class="form-group">
                            ...
                            echo $this->Form->input('instagram_profile',array(
                                'id' => 'instagram_profile',
                                'placeholder' => $this->Psd->text('Enter') .' Instagram URL',
                                'class' => 'form-control input-lg',
								'label' => 'Instagram URL',
								'error' => array('attributes' => array('wrap' => 'div','class' => 'alert alert-warning help-block'))
                            ));
                          ...
                          <div class="form-group">
                            ...
                            echo $this->Form->input('linkedin_profile',array(
                                'id' => 'linkedin_profile',
                                'placeholder' => $this->Psd->text('Enter') .' Linkedin URL',
                                'class' => 'form-control input-lg',
								'label' => 'Linkedin URL',
								'error' => array('attributes' => array('wrap' => 'div','class' => 'alert alert-warning help-block'))
                            ));
                          ...
                          <div class="form-group">
                            ...
                            echo $this->Form->input('twitter_profile',array(
                                'id' => 'twitter_profile',
                                'placeholder' => $this->Psd->text('Enter') .' Twitter URL',
                                'class' => 'form-control input-lg',
								'label' => 'Twitter URL',
								'error' => array('attributes' => array('wrap' => 'div','class' => 'alert alert-warning help-block'))
                            ));
                          ...
                          <div class="form-group">
                            ...
                            echo $this->Form->input('youtube_profile',array(
                                'id' => 'youtube_profile',
                                'placeholder' => $this->Psd->text('Enter') .' YouTube URL',
                                'class' => 'form-control input-lg',
								'label' => 'YouTube URL',
								'error' => array('attributes' => array('wrap' => 'div','class' => 'alert alert-warning help-block'))
                            ));
