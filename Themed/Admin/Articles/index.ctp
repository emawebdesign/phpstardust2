<div class="panel panel-default">
  <div class="panel-body">
  	...
  	<h1><?php echo $this->Psd->text(Inflector::pluralize($model)); ?> <span class="badge"><?php echo $count; ?></span></h1>
                    	...
                    	<div class="table-responsive">
                            <table class="table table-striped"> 
                                <thead> 
                                    <tr> 
                                        <th>#</th> 
                                        <th><?php echo $this->Psd->text('Title'); ?></th>
                                        <th><?php echo $this->Psd->text('Status'); ?></th>
                                ...
                                <tbody> 
                                    ...
                                    <tr> 
                                        ...
                                        <td>
                                        	<?php if ($row[$model]['status']=="published") echo '<span class="label label-success">' .$this->Psd->text('Published') .'</span>'; ?>
                                            <?php if ($row[$model]['status']=="draft") echo '<span class="label label-default">' .$this->Psd->text('Draft') .'</span>'; ?>
                                        </td>
                                        <td>
                                            <?php 
                                              echo $this->Html->link(
                                            ...
                                            ?>
                                            <?php 
                                              if ($row[$model]['image']!="") echo $this->Html->link(
                                                  '<i class="fa fa-crop"></i> ',
                                                  array('action' => 'crop', $row[$model]['id']),
                                                  array('class'=>'btn btn-adf btn-sm', 'escape' => false)
                                              ); 
                                            ?>
                                            <?php 
                                              if ($row[$model]['image']!="") echo $this->Html->link(
                                                  ...
                                                  array('action' => 'resize', $row[$model]['id']),
                                                  array('class'=>'btn btn-adf btn-sm', 'escape' => false)
                                              ); 
                                            ?>
                                            <?php
