  ...
  <div class="panel-body">
    ...
    <div class="row">
        ...
        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        	...
        	<p><a href="<?php echo Configure::read('Psd.url'); ?>/post/<?php echo $this->data[$model]["slug"]; ?>" target="_blank"><i class="fa fa-eye"></i> <?php echo $this->Psd->text('View'); ?></a></p>
                        ...
                        <div class="form-group">
                          ...
                          <div class="form-group">
                            ...
                            <div class='input-group date' id='created'>
                                <input type='text' class="form-control" name="data[<?php echo $model; ?>][created]" value="<?php echo $this->data["Article"]["created"]; ?>" />
