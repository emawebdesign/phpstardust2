...
class SpecialpermissionsController extends PhpstardustAppController {
	
	private $entity = "Specialpermission";
	...
	public function add() {
		...
		$customroles = $this->Customrole->find('list', array(
			'fields' => array('Customrole.id', 'Customrole.name')
		));
